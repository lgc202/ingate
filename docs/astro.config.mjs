          ...
          items: [
            { label: '阅读入口', slug: 'development/overview' },
            {
              ...
              items: [
                ...
                { label: '阅读路线与术语', slug: 'development/architecture/als/reading-guide' },
                ...
                { label: '故障模型与投递语义', slug: 'development/architecture/als/failure-model' },
                { label: '记录 ID 与幂等', slug: 'development/architecture/als/idempotency' },
                { label: '并发与状态迁移', slug: 'development/architecture/als/concurrency' },
                { label: '容量与吞吐规划', slug: 'development/architecture/als/capacity' },
                { label: 'ALS 可观测性', slug: 'development/architecture/als/observability' },
                { label: '设计推演', slug: 'development/architecture/als/reasoning' },
                { label: '验证与测量', slug: 'development/architecture/als/verification' },
              ],
            },
          ],
        },
