...
// strategy 定义 AuthPolicy 资源在 apiserver 存储前后的处理规则
type strategy struct {
	runtime.ObjectTyper
	names.NameGenerator
}

// statusStrategy 定义 AuthPolicy status 子资源更新规则
...
func (strategy) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	policy := obj.(*resource.AuthPolicy)
...
func (strategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newPolicy := obj.(*resource.AuthPolicy)
	oldPolicy := old.(*resource.AuthPolicy)
