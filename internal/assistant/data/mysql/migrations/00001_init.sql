...
CREATE TABLE assistant_run_items (
    ...
    UNIQUE KEY uk_assistant_run_items_call_kind (run_id, call_id, kind),
    KEY idx_assistant_run_items_run_created (run_id, created_at, id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
  COMMENT='运维助手执行步骤';
...
DROP TABLE assistant_run_items;
