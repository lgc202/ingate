// Package source 提供插件源管理和目录同步 API。
package source
...
// Service 实现插件源管理 API。
type Service struct {
	sources *sourcebiz.Usecase
}

// NewService 创建插件源协议服务。
func NewService(sources *sourcebiz.Usecase) *Service {
