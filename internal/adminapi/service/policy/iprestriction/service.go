...
import (
	...
	iprestrictionbiz "github.com/lgc202/ingate/internal/adminapi/biz/policy/iprestriction"
...
func (s *Service) ListIPRestrictionPolicies(
	...
	page, err := s.policies.List(
		...
		conversion.ResourceFilter(request.GetQuery(), request.Enabled, request.GetState()),
	)
	if err != nil {
		return nil, err
	}
	...
	for i := range page.Items {
		policies[i] = policyResponse(&page.Items[i], page.TargetNames)
	}
