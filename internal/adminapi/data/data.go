...
var apiserverProviderSet = wire.NewSet(
	...
	wire.Bind(new(policy.RateLimitLister), new(*apiserver.RateLimitPolicyStore)),
	wire.Bind(new(policy.IPRestrictionLister), new(*apiserver.IPRestrictionPolicyStore)),
	wire.Bind(new(policy.HeaderTransformationLister), new(*apiserver.HeaderTransformationPolicyStore)),
	wire.Bind(new(policy.MockResponseLister), new(*apiserver.MockResponsePolicyStore)),
