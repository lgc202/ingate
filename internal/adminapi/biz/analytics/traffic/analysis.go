...
type TimeBucket analytics.TimeBucket

const (
	// TimeBucketMinute 表示每分钟一个趋势点。
	TimeBucketMinute TimeBucket = TimeBucket(analytics.TimeBucketMinute)
	// TimeBucketFiveMinutes 表示每五分钟一个趋势点。
	TimeBucketFiveMinutes = TimeBucket(analytics.TimeBucketFiveMinutes)
	// TimeBucketHour 表示每小时一个趋势点。
	TimeBucketHour = TimeBucket(analytics.TimeBucketHour)
	// TimeBucketDay 表示每天一个趋势点。
	TimeBucketDay = TimeBucket(analytics.TimeBucketDay)
)
