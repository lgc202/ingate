...
const file_authz_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x17.ingate.authz.conf.DataR\x04data\"\x8c\x01\n" +
	"\x04Data\x12?\n" +
	"\tapiserver\x18\x01 \x01(\v2!.ingate.authz.conf.Data.APIServerR\tapiserver\x1aC\n" +
	"\tAPIServer\x12\x16\n" +
...
var file_authz_proto_goTypes = []any{
	...
	(*Server_GRPC)(nil),         // 5: ingate.authz.conf.Server.GRPC
	(*Server_HTTP)(nil),         // 6: ingate.authz.conf.Server.HTTP
...
var file_authz_proto_depIdxs = []int32{
	...
	5, // 4: ingate.authz.conf.Server.grpc:type_name -> ingate.authz.conf.Server.GRPC
	6, // 5: ingate.authz.conf.Server.http:type_name -> ingate.authz.conf.Server.HTTP
	7, // 6: ingate.authz.conf.Server.shutdown_timeout:type_name -> google.protobuf.Duration
	7, // 7: ingate.authz.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
