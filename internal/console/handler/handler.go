...
import (
	...
	accesscontrolpolicyhandler "github.com/lgc202/ingate/internal/console/handler/accesscontrolpolicy"
	certificatehandler "github.com/lgc202/ingate/internal/console/handler/certificate"
	configurationstatushandler "github.com/lgc202/ingate/internal/console/handler/configurationstatus"
	gatewayhandler "github.com/lgc202/ingate/internal/console/handler/gateway"
	ratelimitpolicyhandler "github.com/lgc202/ingate/internal/console/handler/ratelimitpolicy"
	routehandler "github.com/lgc202/ingate/internal/console/handler/route"
	tokenquotapolicyhandler "github.com/lgc202/ingate/internal/console/handler/tokenquotapolicy"
	upstreamhandler "github.com/lgc202/ingate/internal/console/handler/upstream"
	"github.com/lgc202/ingate/internal/console/pkg/requestid"
	"github.com/lgc202/ingate/internal/console/pkg/response"
	"github.com/lgc202/ingate/internal/console/service"
)

// Handler 聚合 Console HTTP 入口
type Handler struct {
