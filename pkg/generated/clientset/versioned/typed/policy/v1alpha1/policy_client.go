...
// PolicyV1alpha1Client is used to interact with features provided by the policy.ingate.io group.
type PolicyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PolicyV1alpha1Client) AuthPolicies() AuthPolicyInterface {
	return newAuthPolicies(c)
}

func (c *PolicyV1alpha1Client) TrafficPolicies() TrafficPolicyInterface {
	return newTrafficPolicies(c)
}
