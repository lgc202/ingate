...
type RouteInformer interface {
	...
	Lister() gatewayv1alpha1.RouteLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1alpha1().Routes().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha1().Routes().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha1().Routes().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha1().Routes().Watch(ctx, options)
			},
		}, client),
		&apisgatewayv1alpha1.Route{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisgatewayv1alpha1.Route{}, f.defaultInformer)
}

func (f *routeInformer) Lister() gatewayv1alpha1.RouteLister {
	return gatewayv1alpha1.NewRouteLister(f.Informer().GetIndexer())
}
