...
import (
	...
	analyticsserver "github.com/lgc202/ingate/internal/analytics/server"

	_ "go.uber.org/automaxprocs"
)

const (
	serviceName       = "ingate-analytics"
	defaultConfigFile = "configs/ingate-analytics.yaml"
)
...
func newApp(
	...
	consumer *analyticsserver.Consumer,
...
// watchLogging 只热更新日志级别，其他 Analytics 配置在重启后生效
