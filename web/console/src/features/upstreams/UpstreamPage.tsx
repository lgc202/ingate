...
export function UpstreamPage() {
  ...
  return (
    <PageFrame
      title="服务"
      subtitle={`管理 ${resource.data.upstreams.length} 个 HTTP 上游服务`}
