...
const insightModels: Record<InsightKind, InsightModel> = {
  assets: {
    title: '资产',
    subtitle: '从访问日志、路由配置和样本中识别 API、应用、用户、AI、数据和文件资产。',
    createLabel: '确认资产',
    ...
    metrics: [
      ...
      { label: 'AI 资产', value: '7', meta: '模型 / Agent / MCP' },
    ],
    ...
    rows: [
      ...
      },
      {
        ...
        statusText: '已确认',
        updatedAt: '1 小时前',
        evidence: '服务类型为模型服务，访问日志包含 Token 用量字段。',
        suggestion: '可接入 Token 配额、内容安全和提示词审计策略。',
      },
      {
        id: 'file-report',
  ...
  risks: {
    ...
    rows: [
      ...
      },
      {
        ...
        secondary: 'AI 路由 /v1/chat',
        owner: 'partner-a',
        status: 'processing',
        statusText: '治理中',
        updatedAt: '16 分钟前',
        evidence: 'partner-a 在 10 分钟内消耗 42k tokens，高于配额建议线。',
        suggestion: '进入治理动作，给该账号配置临时 Token 配额或限速。',
      },
      {
        id: 'risk-api-unknown',
        name: '未知 API 被访问',
    ...
    rows: [
      {
        ...
        name: 'partner-a',
        type: '账号限流',
        primary: 'Token 配额 50k / 天',
        secondary: 'AI Token 消耗突增',
        owner: '自动执行',
        status: 'processing',
        statusText: '执行中',
        updatedAt: '刚刚',
        evidence: '来源风险：模型 Token 消耗突增；作用范围：partner-a 调用的 AI 路由。',
        suggestion: '等待运行状态回执，确认生效后继续观察 Token 消耗趋势。',
      },
      {
        id: 'gov-disable-api',
