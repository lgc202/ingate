...
const (
	HealthService_Check_FullMethodName = "/ingate.admin.v1.HealthService/Check"
)
...
//
// HealthService 提供进程存活检查
type HealthServiceClient interface {
	Check(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthReply, error)
}
...
func (c *healthServiceClient) Check(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthReply, error) {
...
func (UnimplementedHealthServiceServer) Check(context.Context, *emptypb.Empty) (*HealthReply, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ingate.admin.v1.HealthService",
