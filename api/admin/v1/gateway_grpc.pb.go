...
const (
	GatewayService_ListGateways_FullMethodName  = "/ingate.admin.v1.GatewayService/ListGateways"
	GatewayService_GetGateway_FullMethodName    = "/ingate.admin.v1.GatewayService/GetGateway"
	GatewayService_CreateGateway_FullMethodName = "/ingate.admin.v1.GatewayService/CreateGateway"
	GatewayService_UpdateGateway_FullMethodName = "/ingate.admin.v1.GatewayService/UpdateGateway"
	GatewayService_DeleteGateway_FullMethodName = "/ingate.admin.v1.GatewayService/DeleteGateway"
)
...
func (c *gatewayServiceClient) DeleteGateway(ctx context.Context, in *DeleteGatewayRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGatewayServiceServer) DeleteGateway(context.Context, *DeleteGatewayRequest) (*emptypb.Empty, error) {
...
var GatewayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ingate.admin.v1.GatewayService",
	...
	Metadata: "admin/v1/gateway.proto",
}
