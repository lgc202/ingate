...
const file_admin_v1_rate_limit_policy_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\"\xb7\x02\n" +
	"\x1cCreateRateLimitPolicyRequest\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05 \x01(\x80\x02R\x04name\x12%\n" +
	"\aenabled\x18\x02 \x01(\bB\x06\xbaH\x03\xc8\x01\x01H\x00R\aenabled\x88\x01\x01\x12E\n" +
	"\atargets\x18\x03 \x03(\v2 .ingate.admin.v1.PolicyTargetRefB\t\xbaH\x06\x92\x01\x03\x10\x80\x02R\atargets\x12C\n" +
	...
	"\atargets\x18\x05 \x03(\v2 .ingate.admin.v1.PolicyTargetRefB\t\xbaH\x06\x92\x01\x03\x10\x80\x02R\atargets\x12C\n" +
