...
const (
	RouteService_ListRoutes_FullMethodName  = "/ingate.admin.v1.RouteService/ListRoutes"
	RouteService_GetRoute_FullMethodName    = "/ingate.admin.v1.RouteService/GetRoute"
	RouteService_CreateRoute_FullMethodName = "/ingate.admin.v1.RouteService/CreateRoute"
	RouteService_UpdateRoute_FullMethodName = "/ingate.admin.v1.RouteService/UpdateRoute"
	RouteService_DeleteRoute_FullMethodName = "/ingate.admin.v1.RouteService/DeleteRoute"
)
...
func (c *routeServiceClient) DeleteRoute(ctx context.Context, in *DeleteRouteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRouteServiceServer) DeleteRoute(context.Context, *DeleteRouteRequest) (*emptypb.Empty, error) {
...
var RouteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ingate.admin.v1.RouteService",
